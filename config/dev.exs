...
config :qlock, Qlock.Repo,
  database: Path.expand("../qlock_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :qlock, QlockWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/qlock_web/router\.ex$"E,
      ~r"lib/qlock_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :qlock, dev_routes: true, token_signing_secret: "DtNvmsvQjpFfw5BrZddoE38+QUjxmOLU"
